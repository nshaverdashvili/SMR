    ...
    <div class="container-fluid main">
        <div class="row">
            <div class="form-group">
                <h3><%=Core.Properties.Resources.NotificationTitle %></h3>
                <p>
                    <%=Core.Properties.Resources.NotificationDesc %>
                </p>
            </div>
        </div>

        <div class="row form">
            <h5 class="bottom-border"><%=Core.Properties.Resources.PersonalInformation%></h5>
            <div class="form-group">
            ...
            <h5 class="bottom-border"><%=Core.Properties.Resources.Timeline%></h5>
            <div class="col-xs-6">
                <div class="form-group">
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" TextMode="MultiLine" Rows="5" CssClass="form-control" ID="txtHostContact" ClientIDMode="Static"></asp:TextBox>
            ...
            <h5 class="bottom-border"><%=Core.Properties.Resources.Emergency_Contacts%></h5>
            <div class="col-xs-6">
                <div class="form-group">
            ...
            <h5 class="bottom-border"><%=Core.Properties.Resources.ProjectImplemented%></h5>
            <div class="col-xs-6">
                <div class="form-group">
            ...
            <div class="col-xs-6">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList runat="server" ID="ddIsSent" DataSourceID="dsIsSent" DataTextField="Caption" DataValueField="CodeVal" ClientIDMode="Static" CssClass="form-control">
                    </asp:DropDownList>
