...
namespace Core.DB
{
    ...
    partial void OnCreated();
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), iud, fileID, fileName, descriptionEN, descriptionKA, descriptionRU, uRL, uRLKA, uRLRu, typeID);
